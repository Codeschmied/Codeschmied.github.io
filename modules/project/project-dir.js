...
<h3 class="col-xs-12 col-sm-2 visible-xs" style="word-wrap: break-word">{{project.PrimaryTitle}}</h4>
<h2 class="col-xs-12 col-sm-2  hidden-xs" style="word-wrap: break-word">{{project.PrimaryTitle}}</h3>
<h3 ng-if="project.SecondaryTitle" class="col-xs-12 col-sm-10 visible-xs">{{project.SecondaryTitle}}</h4>
<h2 ng-if="project.SecondaryTitle" class="col-xs-12 col-sm-10  hidden-xs">{{project.SecondaryTitle}}</h4>
</div>
<div class="row">
...
<div class="row">
  ...
  <h4 class="col-xs-12 visible-xs">Tätigkeit und Aufgaben:</h5>
  <div class="col-xs-9 col-sm-10">{{project.Activity}}</div>
</div>
<div class="row">
<div class="col-sm-2 hidden-xs">Technologien</div>
<h4 class="col-xs-12 visible-xs">Technologien:</h5>
...
<h4 class="col-xs-12 visible-xs">Besonderheiten:</h5>
